...
Product := [id: Integer, name: String<1..>, price: NonNegativeReal];
...
==> TestCases :: {
    [
        ...
        ^ => TestResult :: TestResult[
            ...
            actual = ^ :: ?noError(Ox[`Product])->selectAllQuery->as(`DatabaseSqlQuery)
        ],
        ^ => TestResult :: TestResult[
