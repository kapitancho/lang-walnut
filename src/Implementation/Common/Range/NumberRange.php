...
final readonly class NumberRange implements NumberRangeInterface, JsonSerializable {
	...
	public function containsRange(NumberRangeInterface $range): bool {
		return array_all($range->intervals, fn(NumberInterval $interval) =>
			$this->containsInterval($interval));
	}

	public function intersectionWith(NumberRangeInterface $other): NumberRange|null {
		$intervals = [];
	...
	public function unionWith(NumberRangeInterface $other): NumberRange {
