...
use Walnut\Lang\Almond\AST\Blueprint\Node\Type\NumberIntervalEndpointNode as NumberIntervalEndpointNodeInterface;
...
final readonly class NumberIntervalNode implements NumberIntervalNodeInterface {
	public function __construct(
		...
		public MinusInfinity|NumberIntervalEndpointNodeInterface $start,
		public PlusInfinity|NumberIntervalEndpointNodeInterface  $end
	) {}
