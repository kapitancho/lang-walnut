...
final readonly class BinaryLessThan extends TypeNativeMethod {
	...
	protected function getExecutor(): callable {
		return fn(TypeValue $target, TypeValue $parameter): BooleanValue =>
			$this->valueRegistry->boolean(
				$target->typeValue->isSubtypeOf($parameter->typeValue) && !$parameter->typeValue->isSubtypeOf($target->typeValue)
			);
	}
