...
use Walnut\Lang\Almond\Engine\Implementation\Code\NativeCode\NumericClamp;
...
final readonly class Clamp implements NativeMethod {
	...
	public function execute(Value $target, Value $parameter): Value {
		if ($target instanceof IntegerValue && $parameter instanceof RecordValue) {
			return $this->executeHelper($target, $parameter);
		}
		// @codeCoverageIgnoreStart
