...
namespace Walnut\Lang\NativeCode\Shape;
...
final readonly class Shape implements NativeMethod {
	...
	public function execute(
		...
		if ($targetType instanceof ShapeType) {
			...
			$tv = $target->value;
			if ($tv instanceof OpenValue && $tv->value->type->isSubtypeOf($targetType->refType)) {
				return new TypedValue($tv->type->valueType, $tv->value);
			}
