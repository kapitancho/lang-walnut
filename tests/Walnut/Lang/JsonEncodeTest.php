...
final class JsonEncodeTest extends BaseProgramTestHelper {
	...
	public function testTypes(): void {
		...
		foreach([
			...
			'{"type":"Map","itemType":{"type":"Integer","range":{"intervals":[{"start":"MinusInfinity","end":"PlusInfinity"}]}},"range":{"minLength":0,"maxLength":"+Infinity"}}' => $tr->map($tr->integer()),
			'{"type":"Map","itemType":{"type":"Integer","range":{"intervals":[{"start":"MinusInfinity","end":"PlusInfinity"}]}},"range":{"minLength":3,"maxLength":"+Infinity"}}' => $tr->map($tr->integer(), 3),
			'{"type":"Map","itemType":{"type":"Integer","range":{"intervals":[{"start":"MinusInfinity","end":"PlusInfinity"}]}},"range":{"minLength":3,"maxLength":5}}' => $tr->map($tr->integer(), 3, 5),
			'{"type":"Map","itemType":{"type":"Integer","range":{"intervals":[{"start":"MinusInfinity","end":"PlusInfinity"}]}},"range":{"minLength":0,"maxLength":5}}' => $tr->map($tr->integer(), 0, 5),
