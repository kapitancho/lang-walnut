...
final class JsonEncodeTest extends BaseProgramTestHelper {
	...
	public function testExpressions(): void {
		...
		foreach([
	        ...
	        '{"expressionType":"BooleanXor","first":{"expressionType":"constant","value":{"valueType":"Integer","value":0}},"second":{"expressionType":"variableName","variableName":"x"}}' => $er->booleanXor($c0, $x),
	        '{"expressionType":"BooleanNot","first":{"expressionType":"variableName","variableName":"x"}}' => $er->booleanNot($x),
