...
final class CastAsTest extends CodeExecutionTestHelper {
	...
	public function testCastAsSubtype(): void {
		$result = $this->executeCodeSnippet("MyAtomSubtype(MyAtom[])->as(type{MyAtom});",
			"MyAtom = :[]; MyAtomSubtype <: MyAtom;");
		$this->assertEquals("MyAtomSubtype{MyAtom[]}", $result);
	}
