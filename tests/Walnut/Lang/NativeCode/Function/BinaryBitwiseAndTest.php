...
final class BinaryBitwiseAndTest extends CodeExecutionTestHelper {
	...
	public function testNoResultFn1(): void {
		$result = $this->executeCodeSnippet(
			...
			valueDeclarations: "
				...
				fnC = ^s: String => Result<Integer, NotANumber> :: {fn1 & fn2}(s);
			"
		);
	...
	public function testResultDifferent(): void {
		$result = $this->executeCodeSnippet(
			"fnC(25);",
			valueDeclarations: "
	...
	public function testResultDifferentError1(): void {
		$result = $this->executeCodeSnippet(
			"fnC('twenty five');",
			valueDeclarations: "
				fn1 = ^s: JsonValue => Result<Integer, HydrationError> :: s->hydrateAs(`Integer);
	...
	public function testResultDifferentError2(): void {
		$result = $this->executeCodeSnippet(
			"fnC(-3);",
			valueDeclarations: "
				fn1 = ^s: JsonValue => Result<Integer, HydrationError> :: s->hydrateAs(`Integer);
