...
final class ConstructTest extends CodeExecutionTestHelper {
	...
	public function testSubsetWithoutConstructorCallOk(): void {
		$result = $this->executeCodeSnippet("[A[a: 1, b: 'hi'], getA[a: 1, b: 'hi']];", <<<NUT
		A = <: [a: Integer, b: String];
		getA = ^p: [a: Integer, b: String] => A :: A(p);
	NUT);
		$this->assertEquals("[[a: 1, b: 'hi'], [a: 1, b: 'hi']]", $result);
	}

	public function testSubsetWithoutConstructorCallError(): void {
		$this->executeErrorCodeSnippet(
			"Invalid constructor value",
			"A[a: 1, other: 'hi'];",
			<<<NUT
	...
	public function testSubsetWithInvariantConstructorCallOk(): void {
		$result = $this->executeCodeSnippet("[A[a: 1, b: 'hi'], getA[a: 1, b: 'hi']];", <<<NUT
		A = <: [a: Integer, b: String] @ Any :: null;
		getA = ^p: [a: Integer, b: String] => Result<A, Any> :: A(p);
	NUT);
	...
	public function testSubsetWithInvariantConstructorCallOkWrongReturnType(): void {
		$this->executeErrorCodeSnippet(
			"expected a return value of type A, got Result<A, Any>",
			"[A[a: 1, b: 'hi'], getA[a: 1, b: 'hi']];",
		<<<NUT
	...
	public function testSubsetWithInvariantConstructorCallOkErrorValue(): void {
		$result = $this->executeCodeSnippet("A[a: 1, b: 'hi'];", <<<NUT
		A = <: [a: Integer, b: String] @ Any :: => @'error';
	NUT);
		$this->assertEquals("@'error'", $result);
	...
	public function testSubsetWithInvariantConstructorCallError(): void {
		$this->executeErrorCodeSnippet(
			"Invalid constructor value",
			"A[a: 1, other: 'hi'];",
			<<<NUT
