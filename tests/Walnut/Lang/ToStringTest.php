...
final class ToStringTest extends BaseProgramTestHelper {
	...
	public function testTypes(): void {
		...
		foreach([
	        ...
	        'ByteArray' => $tr->byteArray(),
	        'ByteArray<3..>' => $tr->byteArray(3),
	        'ByteArray<3..5>' => $tr->byteArray(3, 5),
	        'ByteArray<..5>' => $tr->byteArray(0, 5),
			'Array' => $tr->array(),
	...
	public function testExpressions(): void {
		...
		foreach([
			...
			'var{x, y} = 0' => $er->multiVariableAssignment([new VariableNameIdentifier('x'), new VariableNameIdentifier('y')], $c0),
