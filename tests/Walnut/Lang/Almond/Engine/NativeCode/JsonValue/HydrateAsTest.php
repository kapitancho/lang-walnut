...
final class HydrateAsTest extends CodeExecutionTestHelper {
	...
	public function testHydrateAsShape(): void {
		$result = $this->executeCodeSnippet("42->hydrateAs(type{Shape<X>});", "X := Integer;");
		$this->assertEquals("X!42", $result);
	}
	...
	public function testHydrateAsBytesFromString(): void {
		$result = $this->executeCodeSnippet("'hello'->hydrateAs(type{Bytes});");
		$this->assertEquals('"hello"', $result);
	}
	...
	public function testHydrateAsRealFromOther(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: null,\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'The value should be a real in (-Infinity..+Infinity)',\n\t\t\ttargetType: type{Real}\n\t\t]\n\t]\n]", $result);
	}
	...
	public function testHydrateAsArrayFromArrayItemTypeIncorrect(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: [1, 2, 'hello'],\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'One or more items in the array failed to hydrate',\n\t\t\ttargetType: type{Array<Integer>}\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value[2]',\n\t\t\terrorMessage: 'The value should be an integer in (-Infinity..+Infinity)',\n\t\t\ttargetType: type{Integer}\n\t\t]\n\t]\n]", $result);
	}
	...
	public function testHydrateAsMapFromMapItemTypeIncorrect(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: [a: 1, b: 2, c: 'hello'],\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'One or more items in the map failed to hydrate',\n\t\t\ttargetType: type{Map<Integer>}\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value.c',\n\t\t\terrorMessage: 'The value should be an integer in (-Infinity..+Infinity)',\n\t\t\ttargetType: type{Integer}\n\t\t]\n\t]\n]", $result);
	}
	...
	public function testHydrateAsSetFromOther(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: null,\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'The value should be a set with a length between 0 and +Infinity',\n\t\t\ttargetType: type{Set}\n\t\t]\n\t]\n]", $result);
	}
	...
	public function testHydrateAsRecordFromRecord(): void {
		$result = $this->executeCodeSnippet("[a: 1, b: 2, c: 'hello', f: 'world']->hydrateAs(type[a: Integer, b: Integer, c: String, d: ?Real, ... String]);");
		$this->assertEquals("[a: 1, b: 2, c: 'hello', f: 'world']", $result);
	}
	...
	public function testHydrateAsTupleFromTuple(): void {
		$result = $this->executeCodeSnippet("[1, 2, 'hello', 3.14]->hydrateAs(type[Integer, Integer, String, ...Real]);");
		$this->assertEquals("[1, 2, 'hello', 3.14]", $result);
	}
	...
	public function testHydrateAsTupleFromTupleWrongPropertyType(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: [1, 2, 'hello'],\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'One or more items in the tuple failed to hydrate',\n\t\t\ttargetType: type[Integer, Integer, Real]\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value[2]',\n\t\t\terrorMessage: 'The value should be a real in (-Infinity..+Infinity)',\n\t\t\ttargetType: type{Real}\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value[2]',\n\t\t\terrorMessage: 'There is no value allowed, \`hello\` provided',\n\t\t\ttargetType: type{Nothing}\n\t\t]\n\t]\n]", $result);
	}
	...
	public function testHydrateAsEnumerationWrongValue(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: 'D',\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'Enumeration type MyEnumeration hydration failed. The enumeration type \"MyEnumeration\" does not contain a value with the name \"D\", ',\n\t\t\ttargetType: type{MyEnumeration}\n\t\t]\n\t]\n]", $result);
	}
	...
	public function testHydrateAsUnionWithIncorrectCorrectType(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: 3.14,\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'Value does not match any type in the union',\n\t\t\ttargetType: type{(String|Integer)}\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'The value should be a string with a length between 0 and +Infinity',\n\t\t\ttargetType: type{String}\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'The value should be an integer in (-Infinity..+Infinity)',\n\t\t\ttargetType: type{Integer}\n\t\t]\n\t]\n]", $result);
	}
	...
	public function testHydrateAsResultWithIncorrectType(): void {
		...
		$this->assertEquals("@HydrationError![\n\tvalue: 3.14,\n\terrors: [\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'Both return type and error type hydration failed.',\n\t\t\ttargetType: type{Result<String, Integer>}\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'The value should be a string with a length between 0 and +Infinity',\n\t\t\ttargetType: type{String}\n\t\t],\n\t\t[\n\t\t\thydrationPath: 'value',\n\t\t\terrorMessage: 'The value should be an integer in (-Infinity..+Infinity)',\n\t\t\ttargetType: type{Integer}\n\t\t]\n\t]\n]", $result);
	}
