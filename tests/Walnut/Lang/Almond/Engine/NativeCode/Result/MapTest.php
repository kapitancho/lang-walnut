...
final class MapTest extends CodeExecutionTestHelper {
	...
	public function testMapArrayInvalidReturnType(): void {
		$this->executeErrorCodeSnippet(
			"Function body return type 'Result<Array<Integer>, Null>' is not compatible with declared return type 'Array<Integer>'.",
			"doMap([]);",
			valueDeclarations: "
	...
	public function testMapMapInvalidReturnType(): void {
		$this->executeErrorCodeSnippet(
			"Function body return type 'Result<Map<Integer>, Null>' is not compatible with declared return type 'Map<Integer>'.",
			"doMap([:]);",
			valueDeclarations: "
	...
	public function testMapSetInvalidReturnType(): void {
		$this->executeErrorCodeSnippet(
			"Function body return type 'Result<Set<Integer>, Null>",
			"doSet([;]);",
			valueDeclarations: "
