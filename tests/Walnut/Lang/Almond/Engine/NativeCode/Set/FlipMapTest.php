...
final class FlipMapTest extends CodeExecutionTestHelper {
	...
	public function testFlipMapReturnTypeNoErrorEmpty(): void {
		$result = $this->executeCodeSnippet("flipMap['a'; 'bcd'; 'ef']",
			valueDeclarations: "
				flipMap = ^p: Set<String<1..3>, 2..5> => Map<String<1..3>:Integer, ..5> :: 
	...
	public function testFlipMapReturnTypeResultNoErrorEmpty(): void {
		$result = $this->executeCodeSnippet("flipMap['a'; 'bcd'; 'ef']",
			valueDeclarations: "
				flipMap = ^p: Set<String<1..3>, 2..5> => Result<Map<String<1..3>:Integer, ..5>, String> :: 
