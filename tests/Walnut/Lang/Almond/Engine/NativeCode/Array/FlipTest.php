...
final class FlipTest extends CodeExecutionTestHelper {
	...
	public function testFlipKeyType(): void {
		$result = $this->executeCodeSnippet(
			"fn['wx', 'yz'];",
			valueDeclarations: "fn = ^m: Array<String<2>, ..3> => Map<String<2>:Integer<0..3>, ..3> :: m->flip;"
		);
	...
	public function testFlipMinLength(): void {
		$result = $this->executeCodeSnippet(
			"fn['wx', 'yz'];",
			valueDeclarations: "fn = ^m: Array<String<2>, 2..3> => Map<String<2>:Integer<0..3>, 1..3> :: m->flip;"
		);
		$this->assertEquals("[wx: 0, yz: 1]", $result);
	}
