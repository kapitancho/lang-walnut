...
final class PartitionTest extends CodeExecutionTestHelper {
	...
	public function testPartitionReturnType(): void {
		$result = $this->executeCodeSnippet(
			...
			valueDeclarations: "
				part = ^a: Array<String|Integer, 3..7> => [matching: Array<String|Integer, ..7>, notMatching: Array<String|Integer, ..7>] :: 
	...
	public function testPartitionReturnTypeErrorNo(): void {
		$result = $this->executeCodeSnippet(
			"part[1, 'hello', 'world', 2, 3, 'foo', 4]; ",
			valueDeclarations: "
				part = ^a: Array<String|Integer, 3..7> => Result<[matching: Array<String|Integer, ..7>, notMatching: Array<String|Integer, ..7>], Real> :: 
