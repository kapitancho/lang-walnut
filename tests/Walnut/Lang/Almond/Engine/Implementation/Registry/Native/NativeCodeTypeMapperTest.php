...
namespace Walnut\Lang\Test\Almond\Engine\Implementation\Registry\Native;
...
class NativeCodeTypeMapperTest extends AlmondBaseTestHelper {
	...
	public function testEmpty(): void {
		$this->assertEquals(
			['Empty', 'Optional', 'Atom', 'Any'],
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->empty)
		);
	}
	...
	public function testTuple(): void {
		$this->assertEquals(
			...
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->tuple([], null))
		);
	}
	...
	public function testRecord(): void {
		$this->assertEquals(
			...
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->record([], null))
		);
	}
	...
	public function testValue(): void {
		$this->assertEquals(
			['Value', 'Any'],
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->value(
				$this->typeRegistry->integer(),
			))
		);
	}
	...
	public function testAlias(): void {
		$this->assertEquals(
			...
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->userland->alias(
	...
	public function testData(): void {
		$this->assertEquals(
			...
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->userland->data(
	...
	public function testOpen(): void {
		$this->assertEquals(
			['Uuid', 'Open', 'Any'],
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->userland->open(
				new TypeName('Uuid')
			))
		);
	}
	...
	public function testAtom(): void {
		$this->assertEquals(
			['NotANumber', 'Atom', 'Any'],
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->userland->atom(
				new TypeName('NotANumber')
			))
		);
	}
	...
	public function testEnumeration(): void {
		$this->assertEquals(
			...
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->userland->enumeration(
	...
	public function testEnumerationSubset(): void {
		$this->assertEquals(
			['Enumeration', 'Any'],
			$this->nativeCodeTypeMapper->getTypesFor($this->typeRegistry->userland->enumerationSubsetType(
				new TypeName('DependencyContainerErrorType'), [
